...
console.log('thia is a number',13.34);
...
console.log('ugualiangza senza conversione','10'=== 10); //giusto
console.log('ugualiangza tra numeri',10 === 10);
console.log('ugualiangza tra stringhe','CIAO' ==='CIAO');
console.log('ugualiangza tra stringhe','PIPPO' === 'pippo');
console.log('ugualiangza tra stringhe','false' === 'true');
...
console.log('underfined', undefined);
